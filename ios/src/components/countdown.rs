...
//! # Examples
//! ```no_run
//! use amp_ios::countdown::{remaining_duration, format_countdown, bucket_for};
...
/// # Examples
/// ```no_run
/// use amp_ios::countdown::remaining_duration;
/// use amp_core::structs::DB;
///
/// # let db = DB::from_dag_tid(
/// #     Some("22100".to_string()),
...
/// # Examples
/// ```no_run
/// use amp_ios::countdown::time_until_next_occurrence;
/// use amp_core::structs::DB;
///
/// # let db = DB::from_dag_tid(
/// #     Some("22100".to_string()),
...
/// # Examples
/// ```no_run
/// use amp_ios::countdown::format_countdown;
/// use amp_core::structs::DB;
///
/// # let db = DB::from_dag_tid(
/// #     Some("22100".to_string()),
...
/// # Examples
/// ```no_run
/// use amp_ios::countdown::{bucket_for, TimeBucket};
/// use amp_core::structs::DB;
///
/// # let db = DB::from_dag_tid(
/// #     Some("22100".to_string()),
