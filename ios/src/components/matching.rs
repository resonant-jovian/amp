...
//! # Examples
//! ```no_run
//! use amp_ios::matching::{match_address, MatchResult};
//!
...
/// # Examples
/// ```no_run
/// use amp_ios::matching::get_parking_data;
///
...
/// # Examples
/// ```
/// use amp_ios::matching::validate_postal_code;
///
...
/// # Examples
/// ```
/// use amp_ios::matching::{validate_input, ValidationError};
///
