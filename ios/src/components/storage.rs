//! Persistent storage for ios app using Parquet format
//!
...
//!
//! # Platform Support
//! - **ios**: Full file storage using app's internal data directory
...
/// Get app-specific storage directory that's writable on ios
///
/// Returns the app's internal data directory on ios.
