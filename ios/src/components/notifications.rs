//! Local ios notifications for parking restriction warnings
//!
//! Provides notification scheduling when addresses transition between time panels.
//! Uses ios's NotificationManager and channels for proper categorization.
//!
...
//! # Examples
//! ```no_run
//! use amp_ios::components::notifications::{initialize_notification_channels, notify_active};
...
/// Initialize notification channels on app startup (ios 8+)
///
...
/// or application class. Safe to call multiple times (ios handles duplicates).
///
/// # Platform Support
/// - **ios 8.0+**: Creates proper notification channels
/// - **ios <8.0**: No-op (channels not required)
/// - **Other platforms**: Mock implementation for testing
///
/// # Examples
/// ```no_run
/// use amp_ios::components::notifications::initialize_notification_channels;
///
...
/// # Examples
/// ```no_run
/// use amp_ios::components::notifications::notify_one_day;
/// use amp_ios::ui::StoredAddress;
///
/// let address = StoredAddress {
///     id: 1,
...
/// # Examples
/// ```no_run
/// use amp_ios::components::notifications::notify_six_hours;
/// use amp_ios::ui::StoredAddress;
///
/// let address = StoredAddress {
///     id: 2,
...
/// # Examples
/// ```no_run
/// use amp_ios::components::notifications::notify_active;
/// use amp_ios::ui::StoredAddress;
///
/// let address = StoredAddress {
///     id: 3,
