//! Dioxus UI components for the ios parking app.
//!
//! This module provides the user interface layer built with Dioxus, a reactive
//! UI framework that compiles to native ios views.
//!
//! # Architecture
//!
...
//!
//! The app integrates with ios lifecycle:
...
//! - [`crate::ios_bridge`]: Native ios integration
...
/// # Examples
/// ```no_run
/// use amp_ios::ui::fuzzy_match_address;
///
/// // Exact match
