    ...
    rsx! {
        div { class: "category-container category-active",
            ...
            div { class: "category-content",
                div { class: "category-addresses", id: "container-active" }
                div { class: "category-timers", id: "timers-active" }
            }
        }
    }
}
...
pub fn Six() -> Element {
    rsx! {
        div { class: "category-container category-6h",
            ...
            div { class: "category-content",
                div { class: "category-addresses", id: "container-6h" }
                div { class: "category-timers", id: "timers-6h" }
            }
        }
    }
}
...
pub fn Day() -> Element {
    rsx! {
        div { class: "category-container category-24h",
            ...
            div { class: "category-content",
                div { class: "category-addresses", id: "container-24h" }
                div { class: "category-timers", id: "timers-24h" }
            }
        }
    }
}
...
pub fn Month() -> Element {
    rsx! {
        div { class: "category-container category-month",
            ...
            div { class: "category-content",
                div { class: "category-addresses", id: "container-month" }
                div { class: "category-timers", id: "timers-month" }
            }
        }
    }
}
...
pub fn NotValid() -> Element {
    rsx! {
        div { class: "category-container category-invalid",
            ...
            div { class: "category-content",
                div { class: "category-addresses", id: "container-none" }
                div { class: "category-timers", id: "timers-none" }
            }
        }
    }
}
