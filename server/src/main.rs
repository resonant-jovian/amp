...
fn create_tabbed_interface_page(address: &str, result: &CorrelationResult) -> String {
    ...
    html.push_str("                \n");
    html.push_str("                // API uses Swedish naming: 'adress' not 'name'\n");
    html.push_str("                const name = result.adress || result.name || result.address || 'Unknown';\n");
    html.push_str("                const x = result.x;\n");
    html.push_str("                const y = result.y;\n");
    html.push_str("                \n");
